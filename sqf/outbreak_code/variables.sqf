...
ZOMBIE_SPAWN_RANGE_CITY_MAX = 60;
ZOMBIE_SPAWN_RANGE_CITY_MIN = 20;
ZOMBIE_SPAWN_CITY = 12;

ZOMBIE_SPAWN_RANGE_VILLAGE_MAX = 40;
ZOMBIE_SPAWN_RANGE_VILLAGE_MIN = 20;
ZOMBIE_SPAWN_VILLAGE = 6;

LOOT_SPAWN_RADIUS = 120;
