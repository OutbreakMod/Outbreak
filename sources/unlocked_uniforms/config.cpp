// config.bin - 15:01:27 04/11/16, generated in 0.00 seconds
...
class CfgVehicles {
	...
	class U_B_GhillieSuit : B_sniper_F {
		displayName = "Ghillie Suit";
		modelsides[] = {3, 2, 1, 0};
		scope = 2;
	};

	class U_I_GhillieSuit : B_sniper_F {
		displayName = "Ghillie Suit";
		modelsides[] = {3, 2, 1, 0};
		scope = 2;
	};
...
class CfgWeapons {
	...
	class U_B_GhillieSuit : U_I_OfficerUniform {
