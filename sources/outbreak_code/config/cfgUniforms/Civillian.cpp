class MOD_CivillianUniform1 : MOD_Uniform_Base {
...
class MOD_CivillianUniform2 : MOD_Uniform_Base {
	author = "$STR_A3_Bohemia_Interactive";
	scope = 2;
...
class MOD_CivillianUniform3 : MOD_Uniform_Base {
	author = "$STR_A3_Bohemia_Interactive";
	scope = 2;
...
class MOD_CivillianUniform4 : MOD_Uniform_Base {
	author = "$STR_A3_Bohemia_Interactive";
	scope = 2;
...
class MOD_CivillianUniform5 : MOD_Uniform_Base {
	author = "$STR_A3_Bohemia_Interactive";
	scope = 2;
...
class MOD_CivillianUniform6 : MOD_Uniform_Base {
	author = "$STR_A3_Bohemia_Interactive";
	scope = 2;
...
class MOD_CivillianUniform7 : MOD_Uniform_Base {
	author = "$STR_A3_Bohemia_Interactive";
	scope = 1;
...
class MOD_CivillianUniform8 : MOD_Uniform_Base {
	author = "$STR_A3_Bohemia_Interactive";
	scope = 1;
	displayName = "$STR_A3_common_clothes1";
	picture = "\A3\characters_f\data\ui\icon_U_Citizen_ca.paa";
...
class MOD_CivillianUniform9 : MOD_Uniform_Base {
	author = "$STR_A3_Bohemia_Interactive";
	scope = 1;
...
class MOD_CivillianUniform10 : MOD_Uniform_Base {
		author = "$STR_A3_Bohemia_Interactive";
		scope = 2;
...
class MOD_CivillianUniform11 : MOD_Uniform_Base {
	author = "$STR_A3_Bohemia_Interactive";
	scope = 1;
